...
const ownerNumber = "6289507948843@s.whatsapp.net"
const dtod = "6289507948843@s.whatsapp.net"
const otod = "6289507948843@s.whatsapp.net"
// STICKER WM
...
YuzApi = 'Yuzzu'
const  = moment().tz('Asia/Jakarta').format("HH:mm:ss")
...
const sleep = async (ms) => {
    return new Promise(resolve => setout(resolve, ms));
}
...
try {
		...
		const  = moment.tz('Asia/Jakarta').format('DD/MM HH:mm:ss')
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const sekarang = new Date().get();
            ...
            const jmn = moment.tz('Asia/Jakarta').format('HH:mm:ss')
				let d = new Date
				let locale = 'id'
				let gmt = new Date(0).get() - new Date('1 Januari 2021').get()
		...
		const 2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
if(2 < "23:59:00"){
var image = await getBuffer('https://i.pinimg.com/736x/27/ee/27/27ee271709bdb24d555b2dd3de796f93.jpg')
                                        }
if(2 < "19:00:00"){
var image = await getBuffer('https://i.pinimg.com/736x/27/ee/27/27ee271709bdb24d555b2dd3de796f93.jpg')
                                         }
if(2 < "18:00:00"){
var image = await getBuffer('https://i.pinimg.com/736x/81/08/7b/81087b2e732dc0e25d8875b135d579b9.jpg')
                                         }
if(2 < "15:00:00"){
var image = await getBuffer('https://i.pinimg.com/736x/81/98/aa/8198aaf07083fc9939deb0c3c5c3716c.jpg')
                                         }
if(2 < "11:00:00"){
var image = await getBuffer('https://i.pinimg.com/736x/81/98/aa/8198aaf07083fc9939deb0c3c5c3716c.jpg')
                                         }
if(2 < "06:00:00"){
var image = await getBuffer('https://i.pinimg.com/736x/15/8e/ea/158eea299c01433aae6744599d2fdc3a.jpg')
}
const ftok = {
key: {
			fromMe: false,
...
const addRegisteredUser = (userid, sender, age, , serials) => {
const obj = { id: userid, name: sender, age: age, : , serial: serials }
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const sendStickerUrl = async(to, url) => {
			console.log(color(, 'magenta'), color(moment.tz('Asia/Jakarta').format('HH:mm:ss'), "gold"), color('Downloading sticker'))
				...
				download(url, namea, async function () {
					...
					console.log(color(, 'magenta'), color(moment.tz('Asia/Jakarta').format('HH:mm:ss'), "gold"), color('Succes send sticker'))
					});
					});
				});
			}
		...
		const reply = (teks) => {
			kurr.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"SEWA BOT PENCET INI",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/5372544132763788/6285975115558`}}})
		}
...
console.log(color('[EVAL]'), color(moment(mek.messagestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'yellow'), color(`Eval V1 brooo`))
ras = budy.slice(1)
function _(rem) {
...
reply('http://youtube.com/c/KurrXd')
   ...
   const sotoy = [
	    ...
	    if (isCmd && !isGroup) {console.log(color('|CMD|', 'greenyellow'), color(moment(mek.messagestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'blue'), color(`${command} [${args.length}]`, 'cyan'), color(`${pushname}`, 'orange'), color(`${sender}`, 'deeppink'))}
	    if (!command) {console.log(color('|MSG|', 'greenyellow'), color(moment(mek.messagestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'blue'), color(cmd, 'cyan'), color(`${pushname}`, 'orange'), color(`${sender}`, 'deeppink'))}
...
冬 ${prefix}leave [ _detik/menit/jam_ ]
冬 ${prefix}buka [ _detik/menit/jam_ ]
冬 ${prefix}tutup [ _detik/menit/jam_ ]
...
kurr.sendMessage(from, sendBtnVeryy, MessageType.buttonsMessage, {quoted:ftrol, contextInfo: { mentionedJid: [sender]}})
	         console.log(color('[REGISTER]'), color(, 'yellow'), 'Serial:', color(serialUser, 'cyan'), 'in', color(sender || groupName))
	    // console.log(e)
        break
// BIAR GAK LUPA 
//LUPA
...
//🐀💰 MALING
  ...
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					sticWait(from)
					console.log(color(, 'magenta'), color('Downloading sticker...'))
  ...
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					if (err) return reply(mess.error.stick)
					kurr.sendMessage(from, fs.readFileSync(rano), sticker, {quoted: mek})
					console.log(color(, 'magenta'), color('Succes send sticker...'))
					fs.unlinkSync(rano)
					})
					} else {
					reply('Gunakan foto!')
...
if (!isBotGroupAdmins) return sticNotAdmin(from)
if (args[1]=="detik") {var r = args[0]+"000"
} else if (args[1]=="menit") {var r = args[0]+"0000"
} else if (args[1]=="jam") {var r = args[0]+"00000"
